...
def menu_clientes():
    opcion = ""
    # El menu se repite hasta que el usuario elige 0 para volver
    while opcion != "0":
        print("\n" + "=" * 40)
        ...
        # Segun la opcion elegida llamamos a la funcion que corresponde
        if opcion == "1":
            crear_cliente()
        elif opcion == "2":
            listar_clientes()
...
def menu_empleados():
    ...
    while opcion != "0":
        print("\n" + "=" * 40)
        print(titulo("GESTION DE EMPLEADOS"))
        print("=" * 40)
...
def menu_productos():
    ...
    while opcion != "0":
        print("\n" + "=" * 40)
        print(titulo("GESTION DE PRODUCTOS"))
        print("=" * 40)
...
def menu_promociones():
    ...
    while opcion != "0":
        print("\n" + "=" * 40)
        print(titulo("GESTION DE PROMOCIONES"))
        print("=" * 40)
...
def menu_principal():
    opcion = ""
    # El menu principal se mantiene activo hasta elegir salir
    while opcion != "0":
        print("\n" + "=" * 40)
        print(titulo("SISTEMA DE GESTION - GRUPO 14"))
        print("=" * 40)
...
# Si el login da True recien ahi mostramos el menu principal
if iniciar_sesion():
    menu_principal()
